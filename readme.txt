...
Expand tabs free is a jQuery tabs plugin for your wordpress website. This plugin will enable awesome lightweight tabs function.
...
1. Add some tab content on tabs custom post with a category. You can add multiple tab items in a category. Now go to post of page editor, go to visual editor. Click Expand Tabs Shortcode & Use Tabs form custom post & fill with your information. Now save the post/page & view page. You will see tabs there. 
